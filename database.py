...
fields = {
    ...
    "inventory" : [[0, "skinid"], [0, "weaponid"], [0, "quality"], [0, "wear"], [1, "float"], [0, "statOrSouv"], [0, "patternid"]],
}
...
"""int id (pk), int skinid (fk), int weaponid (fk), int quality, int wear, float float, int patternid (fk), str statOrSouv
"""
